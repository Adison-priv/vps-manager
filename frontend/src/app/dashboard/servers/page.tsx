            ...
            <div className="bg-[#0f1629] border border-[#1b2540] rounded-2xl p-8">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-5">
                    ...
                    {servers.map((server) => (
                        ...
                        <div
                            key={server.id}
                            className="group relative overflow-hidden rounded-3xl border border-[#1b2540] bg-linear-to-b from-[#0f172d] to-[#0b1224] p-5 transition-all duration-300 hover:border-[#2b3c67] hover:shadow-[0_0_40px_rgba(59,130,246,0.12)]"
                        >
                            ...
                            <div className="flex items-start justify-between">
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    {/* ICON */}
                                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-linear-to-br from-[#1d4ed8]/30 to-[#2563eb]/10 border border-[#2a3c66]">
                            ...
                            <div className="mt-6 flex items-center justify-between border-t border-[#1a2338] pt-4">
                                ...
                                <div className="flex items-center gap-2">
                                   ...
                                   <button
                                        ...
                                        className="rounded-xl border border-[#24304d] bg-[#111827] px-4 py-2 text-sm text-white transition hover:bg-[#172036]"
                                    >
                                        View details
                                    </button>
